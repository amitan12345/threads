<div>
    <button data-model-target="defaultModal" data-modal-toggle="defaultModal" class="rounded-full w-16 h-16 bg-blue-600 fixed bottom-5 right-5 flex justify-center items-center">
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg flex justify-center items-center h-[80vh]">
                <form wire:submit="createThread">
                    ...
                    <input data-modal-hide="defaultModal" type="submit" value="Create Thread" class="bg-gray-400 rounded-lg">
                </form>
            </div>
        </div>
    </div>

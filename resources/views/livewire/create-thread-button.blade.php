<div>
    <button data-model-target="createThreadModal" data-modal-toggle="createThreadModal" class="rounded-full w-16 h-16 bg-blue-600 fixed bottom-24 right-5 flex justify-center items-center">
